...
SELECT F.Nome, G.Genero FROM Filmes AS F JOIN FilmesGenero AS FG ON FG.IdFilme = F.Id JOIN Generos AS G ON G.Id = FG.IdGenero;

--  Buscar o nome do filme e o gênero do tipo "Mistério"
SELECT F.Nome, G.Genero FROM Filmes AS F JOIN FilmesGenero AS FG ON FG.IdFilme = F.Id JOIN Generos AS G ON G.Id = FG.IdGenero WHERE G.Genero = 'Mistério';

-- Buscar o nome do filme e os atores, trazendo o PrimeiroNome, UltimoNome e seu Papel
SELECT F.Nome, A.PrimeiroNome, A.UltimoNome, EF.Papel FROM Filmes AS F JOIN ElencoFilme AS EF ON EF.IdFilme = F.Id JOIN Atores AS A ON A.Id = EF.IdAtor;